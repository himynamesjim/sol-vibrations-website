  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-4xl px-4 py-16 sm:px-6">
        <p className="mx-auto mb-8 max-w-xl text-center font-display text-lg font-bold text-sol-deep">
          Our lessons are free, instruments provided if needed, no musical background required.
        </p>
        <EnrollForm
